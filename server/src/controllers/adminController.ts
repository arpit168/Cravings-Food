...
export const getPlatformStats = async (req: Request | any, res: Response, next: NextFunction) => {
  try {
...
export const getAllUsers = async (req: Request | any, res: Response, next: NextFunction) => {
  try {
...
export const toggleRestaurantFeatured = async (req: Request | any, res: Response, next: NextFunction) => {
  try {
...
export const updateUserStatus = async (req: Request | any, res: Response, next: NextFunction) => {
  try {
...
export const updateRestaurantStatus = async (req: Request | any, res: Response, next: NextFunction) => {
  try {
