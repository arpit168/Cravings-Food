...
export const getAllRestaurants = async (req: Request | any, res: Response, next: NextFunction) => {
  try {
...
export const getRestaurantById = async (req: Request | any, res: Response, next: NextFunction) => {
  try {
...
export const createRestaurant = async (req: Request | any, res: Response, next: NextFunction) => {
  try {
...
export const addMenuItem = async (req: Request | any, res: Response, next: NextFunction) => {
  try {
...
export const getOwnerRestaurants = async (req: Request | any, res: Response, next: NextFunction) => {
  try {
...
export const getOwnerOrders = async (req: Request | any, res: Response, next: NextFunction) => {
  try {
    const restaurants = await Restaurant.find({ ownerId: req.user._id });
    const restaurantIds = restaurants.map((r) => r._id);
...
export const updateOwnerOrderStatus = async (req: Request | any, res: Response, next: NextFunction) => {
  try {
...
export const toggleStoreStatus = async (req: Request | any, res: Response, next: NextFunction) => {
  try {
...
export const updateStoreTiming = async (req: Request | any, res: Response, next: NextFunction) => {
  try {
...
export const toggleMenuItemAvailability = async (req: Request | any, res: Response, next: NextFunction) => {
  try {
...
export const requestOwnerPayout = async (req: Request | any, res: Response, next: NextFunction) => {
  try {
