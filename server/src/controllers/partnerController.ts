...
export const getAvailableOrders = async (req: Request | any, res: Response, next: NextFunction) => {
  try {
...
export const getPartnerDeliveries = async (req: Request | any, res: Response, next: NextFunction) => {
  try {
...
export const acceptDeliveryOrder = async (req: Request | any, res: Response, next: NextFunction) => {
  try {
...
export const updateDeliveryStatus = async (req: Request | any, res: Response, next: NextFunction) => {
  try {
...
export const updatePartnerProfile = async (req: Request | any, res: Response, next: NextFunction) => {
  try {
...
export const togglePartnerOnlineStatus = async (req: Request | any, res: Response, next: NextFunction) => {
  try {
    const partner = await User.findById(req.user._id);
...
export const withdrawPartnerWallet = async (req: Request | any, res: Response, next: NextFunction) => {
  try {
