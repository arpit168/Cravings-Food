 ...
 */
export const getActiveCoupons = async (req: Request | any, res: Response, next: NextFunction) => {
  try {
    const now = new Date();
 ...
 */
export const validateCoupon = async (req: Request | any, res: Response, next: NextFunction) => {
  try {
