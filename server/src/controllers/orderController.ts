...
export const getCustomerOrders = async (req: Request | any, res: Response, next: NextFunction) => {
  try {
...
export const getOrderById = async (req: Request | any, res: Response, next: NextFunction) => {
  try {
...
export const updateOrderStatus = async (req: Request | any, res: Response, next: NextFunction) => {
  try {
