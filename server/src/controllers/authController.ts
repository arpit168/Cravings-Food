...
export const UserRegister = async (req: Request | any, res: Response, next: NextFunction) => {
  try {
...
export const UserLogin = async (req: Request | any, res: Response, next: NextFunction) => {
  try {
...
export const VerifyOtp = async (req: Request | any, res: Response, next: NextFunction) => {
  try {
...
export const UserLogout = async (req: Request | any, res: Response, next: NextFunction) => {
  try {
